...
<header>
    ...
    <nav class="navbar">
        <a class="navitem active" href="./home.php">Home</a>
        <a class="navitem" href="./tour.php">Tour</a>
        <a class="navitem" href="./agency.php">Agency</a>
        <a class="navitem" href="./news.php">News</a>
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="./sigiriya.php" class="btn" >visit tour</a>
            </div>
        </div>

        <div class="box">
            <img src="Image/ambuwawa.jpeg" alt="">
            <div class="content">
                ...
                <div class="price"> $100.00 <span> $150.00</span></div>
                <a href="./tour.html" class="btn">visit tour</a>
            </div>
        </div>
