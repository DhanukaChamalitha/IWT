...
<header>
    ...
    <nav class="navbar">
        ...
        <a class="navitem active" href="./agency_user.php">Agency</a>
...
<section class="trande" id="trande">
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="content">
                <h3><i class="fas fa-map-marker-alt"></i>agency1</h3>
                ...
                <a href="#" class="btn">book now</a><br><br>
                <h3>More tours</h3>
                <br>
                <!--tours provide by acency start-->
